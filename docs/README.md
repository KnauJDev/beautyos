...
**No empieces por el código.** Este proyecto tiene 211 decisiones registradas
...
|---|---|---|
| **D-001 … D-211** | **Decisiones.** El porqué de cada cosa, con lo que se descartó y por qué | `00_producto/REGISTRO_DE_DECISIONES.md` |
