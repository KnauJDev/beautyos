...
| # | Qué | Quién | Estado |
|---|---|---|---|
| 9.12 | **Recorrer el producto entero como una dueña nueva, de cero y sin saltarse nada:** registrarse, esperar aprobación, pagar, configurar servicios, invitar a una estilista, crear una cita, cobrarla, cerrar la caja y mirar los reportes. Anotando **cada** fricción | 👥 | ⬜ |
...
| # | Qué | Quién | Estado |
|---|---|---|---|
| 9.13 | **Sacar la lógica de dinero de `tickets_page.dart`** (5.121 líneas) a `services/`. Mover cómo se cobra fuera de dónde se dibujan los botones | 🤖 | ⬜ |
| 9.14 | Lo mismo con `platform_panel_page.dart` (4.230) y `settings_page.dart` (3.311) | 🤖 | ⬜ |
