...
| 8.38 | **Añadir verificación estática de las Edge Functions al CI (hallazgo AB).** Sale de D-215: un `ReferenceError` trivial llegó a producción porque nadie mira `supabase/functions/` | 🤖 | ⬜ Un `deno check` sobre `supabase/functions/**` en `ci.yml`. Es el hueco de TL-07, cerrado para Dart y abierto para TypeScript |
