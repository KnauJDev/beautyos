...
| # | Qué | Quién | Estado |
|---|---|---|---|
| 9.15 | **Supabase a plan Pro** (era 3.4). En el gratuito no hay recuperación a un punto en el tiempo: si se pierden datos, se vuelve al último respaldo corrido a mano | 👤 | ⬜ |
| 9.16 | **El contador: DIAN e IVA** (era 3.2). Facturar sin saber qué se debe es un problema legal, no técnico | 👤 | ⬜ |
| 9.17 | **HSTS en Cloudflare** (era 8.25) y **rotar la contraseña de la base** (hallazgo X, nunca se ha rotado) | 👤 | ⬜ |
...
| 9.19 | 🔴 **La base limpia.** Los negocios de prueba viven en la base de producción junto a una intervención manual sobre un pago real. Decidir si se purgan o se marcan con el mecanismo de D-120. **Y la pregunta de detrás: ¿las métricas de plataforma los están contando?** Si sí, el primer número real será falso | 👥 | ⬜ |
