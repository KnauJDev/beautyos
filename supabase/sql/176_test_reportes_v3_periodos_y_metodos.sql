...
begin
  ...
  values ('Centro Estética Control 176', 'peluqueria', 'control176@salonymas.com', '+573001112233', true, true)
  returning id into v_tenant_id;

  -- 2. Auth y membresía
  insert into auth.users (id, email)
  values (v_owner_user_id, 'owner_176_' || floor(random()*100000)::text || '@salonymas.com');
  ...
  values (v_tenant_id, 'Sede Principal 176', 'sede-176-' || floor(random()*100000)::text, 'America/Bogota', 'COP', true, true)
